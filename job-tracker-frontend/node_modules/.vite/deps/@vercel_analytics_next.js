...
//#region optional-peer-dep:__vite-optional-peer-dep:next/navigation.js:@vercel/analytics
...
var import_analytics = require_analytics();
var initQueue = () => {
	if (window.va) return;
...
var useRoute = () => {
	const params = (0, import_analytics.useParams)();
	const searchParams = (0, import_analytics.useSearchParams)();
	const path = (0, import_analytics.usePathname)();
	if (!params) return {
		route: null,
		path
	};
